...
class TaxonomyIndexTidOptions extends TaxonomyIndexTidDepth {
  ...
  public function submitExposeForm($form, FormStateInterface $form_state) {
    ...
    $this->options['expose']['limit_depth'] = $form_state->getValue(['options', 'expose', 'limit_depth']);
    $this->options['expose']['include_children'] = $form_state->getValue(['options', 'expose', 'include_children']);
  }
