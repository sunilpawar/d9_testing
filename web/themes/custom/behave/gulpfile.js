...
options.drupalURL = 'http://d8.behavenet.com';
...
options.styleGuide = {
  ...
  css: [
    ...
    path.relative(options.rootPath.styleGuide, options.theme.css + 'fields.css'),
    ...
    // Behavenet tweaks
    path.relative(options.rootPath.styleGuide, options.theme.css + 'behavenet.css'),
    path.relative(options.rootPath.styleGuide, options.theme.css + 'ads.css')
  ],
  js: [
  ],

  homepage: 'homepage.md',
  title: 'behave Style Guide'
};
