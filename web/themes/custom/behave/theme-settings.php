 ...
 */
function behave_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['behave_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('behave sample setting'),
  '#default_value' => theme_get_setting('behave_example'),
